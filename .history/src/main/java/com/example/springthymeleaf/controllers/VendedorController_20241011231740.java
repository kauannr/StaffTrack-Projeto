...
public class VendedorController {
    ...
    public ModelAndView vendasNoPeriodo(@PathVariable("idPessoa") long idPessoa,
        ...
        redirectAttributes.addObject("listaVendas", listaVendas);
        redirectAttributes.addObject("objVenda", new Vendas());
        redirectAttributes.addObject("objVendedor", new Vendedor());
