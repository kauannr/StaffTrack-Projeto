...
public class VendedorController {
    ...
    public ModelAndView salvar(Vendedor vendedor, BindingResult bindingResult) {
        ...
        GerenteVendas gerente = gerenteVendasService.findById(vendedor.getGerente().getId())
        Contrato contrato = contratoService.findById(vendedor.getContrato().getId()).get();
        
        vendedor.setGerente(gerente);
        vendedor.setContrato(contrato);
    ...
    public ModelAndView pesquisarVendas(@PathVariable("idPessoa") long idPessoa, @RequestParam(required = false) Long idVenda,
        ...
        if (idVenda != null) {
            ...
            listaVendas = vendasService.findByValorVendaAndVendedor(valorVenda, vendedor.get(),PageRequest.of(page, size));
        } else {
