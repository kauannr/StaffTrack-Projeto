...
public class VendedorController {
    ...
    @RequestMapping(value = "**/atualizarvendedor/{idPessoa}", method = RequestMethod.GET)
    public ModelAndView editar(@PathVariable("idPessoa") Long id, ModelAndView modelAndView) {
