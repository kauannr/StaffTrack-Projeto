...
public class GerenteVendasController {
    ...
    @RequestMapping(value = "atualizarbeneficio/{idBeneficio}", method=RequestMethod.GET)
    public ModelAndView atualizarBeneficio(@PathVariable("idBeneficio") long idBeneficio, ModelAndView modelAndView, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("objBeneficio", beneficio);

        modelAndView.setViewName("redirect:/salvarbeneficiogerente/" + beneficio.getContrato().getPessoa().getId());
