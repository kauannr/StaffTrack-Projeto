...
public class VendedorController {
    ...
    public ModelAndView pesquisarVendas(@RequestParam(required = false) Long idVenda,
        ...
        if (idVenda != null) {
            ...
            listaVendas = vendasService.findByValorVenda(valorVenda, PageRequest.of(page, size));
        } else {
    ...
    public String vendasNoPeriodo(@PathVariable("idPessoa") long idPessoa,
            ...
            @RequestParam(defaultValue = "5") int size, ModelAndView modelAndView, RedirectAttributes redirectAttributes) {
        ...
        //return modelAndView;
        return new ModelAndView("redirect:/vendasnoperiodo/" + vendedor.get().getId()) + "?";
