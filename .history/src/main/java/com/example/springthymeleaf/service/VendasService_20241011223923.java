...
public class VendasService {
    ...
    public Page<Vendas> findByValorVenda(Double valorVenda, Pageable pageable) {
        return vendasRepository.findByValorVenda(valorVenda, pageable);
    }
    ...
    public Page<Vendas> vendasNoPeriodo(Vendedor vendedor, Date de, int ate, Pageable pageable) {

        return vendasRepository.findAllByVendedorAndDataVendaBetween(vendedor, null, null, pageable);
    }
