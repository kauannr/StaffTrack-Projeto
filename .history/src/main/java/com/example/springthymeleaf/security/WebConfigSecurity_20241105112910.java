...
public class WebConfigSecurity {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .requestMatchers(HttpMethod.GET, "/materialize/**").permitAll() // Permite acesso público a recursos
                                                                                // estáticos
                .requestMatchers("/telefones/{idPessoa}").hasAnyRole("MANAGER") // Permissão para acessar rota
                                                                                // específica
